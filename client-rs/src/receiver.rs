...
/// infrastructure headers and adding BotMsg metadata.
fn build_forward_headers(
    ...
    out.insert("X-BotMsg-Channel-Id".into(), channel_id.to_string());
    out.insert("X-BotMsg-Request-Id".into(), req_id.into());
...
pub async fn call_receiver(
    ...
    builder = builder.body(body_str).timeout(std::time::Duration::from_secs(15));
